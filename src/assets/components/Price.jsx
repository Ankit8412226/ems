...
export default function PricingSection() {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-10 py-12 bg-white">
      ...
      {/* Heading */}
      <h1 className="text-[#1B223C] font-poppins text-[38.4px] font-medium tracking-[-0.873px] text-center leading-tight">
        Lorem ipsum dolor sit amet <br />
        <span className="text-[#50AA18]">consectetur. kshi</span>
      </h1>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-end gap-1 mt-1 relative z-10">
                ...
                <span className="text-[#7C7C7C] text-[16px] pb-1">per month</span>
              </div>
              ...
              <button
                className={`
                  ...
                  ${isGrowth
                    ? "bg-[#756FCC] text-white"
                    : "text-[#756FCC]"} // outline button
                `}
              >
                Get Started
              </button>
